...
(function (global) {
  ...
  var I18N = {
    en: {
      ...
      'login.identifierPlaceholder': 'Enter your email or username',
      'login.noAccount': "Don't have an account?",
      'login.signUp': 'Sign up',
      'signup.title': 'Create your account',
      'signup.heading': 'Sign up',
      'signup.blurb': 'Create an account to save and revisit your analyses.',
      'signup.email': 'Email',
      ...
      'result.legendStrong': 'Strong (OT ≥0.4)',
      'result.legendModerate': 'Moderate (0.2–0.4)',
      'result.legendWeak': 'Weak (<0.2)',
      ...
      'result.setAnyAiKey': 'No AI model is configured. Set an API key on the server (Gemini, Anthropic, or OpenAI), then pick a model from the top-bar “AI Model” menu.',
    ...
    ko: {
      ...
      'login.identifierPlaceholder': '이메일 또는 사용자 이름을 입력하세요',
      'login.noAccount': '계정이 없으신가요?',
      'login.signUp': '회원가입',
      'signup.title': '계정 만들기',
      'signup.heading': '회원가입',
      'signup.blurb': '분석을 저장하고 다시 보려면 계정을 만드세요.',
      'signup.email': '이메일',
      'signup.emailPlaceholder': 'you@example.com',
      'signup.passwordPlaceholder': '6자 이상',
      'signup.confirm': '비밀번호 확인',
      'signup.confirmPlaceholder': '비밀번호를 다시 입력하세요',
      ...
      'result.legendStrong': '강함 (OT ≥0.4)',
      'result.legendModerate': '보통 (0.2–0.4)',
      'result.legendWeak': '약함 (<0.2)',
      ...
      'result.setAnyAiKey': 'AI 모델이 설정되지 않았습니다. 서버에 API 키(Gemini, Anthropic 또는 OpenAI)를 설정한 뒤 상단 “AI 모델” 메뉴에서 모델을 선택하세요.',
