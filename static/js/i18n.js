...
(function (global) {
  ...
  var I18N = {
    en: {
      ...
      'index.diseaseLabel': 'Disease(s)',
      'index.diseasePlaceholder': 'Type a disease, then pick to add (up to 3)...',
      ...
      'term.input': 'Input',
      'term.inputHint': 'Type a disease or clinical phrase',
      ...
      'result.usedIntersection': 'This analysis used the shared center — genes common to all selected diseases.',
      'result.usedUnion': 'This analysis used the whole diagram — genes linked to any selected disease.',
      ...
      'choose.subtitle': 'You selected more than one disease. Choose whether the analysis should use the genes shared by all diseases (intersection), the genes in any disease (union), or run both side by side.',
      ...
      'result.kpiDiseasesCombined': 'Diseases combined',
    ...
    ko: {
      ...
      'index.diseaseLabel': '질병 (영어)',
      'index.diseasePlaceholder': '질병을 입력한 뒤 목록에서 선택하세요 (최대 3개)...',
      ...
      'term.title': '용어 매핑',
      'term.input': '입력',
      'term.inputHint': '질병 또는 임상 표현을 입력하세요',
      ...
      'result.usedIntersection': '이 분석은 공유 중심 — 선택한 모든 질병이 공통으로 가진 유전자를 사용했습니다.',
      'result.usedUnion': '이 분석은 다이어그램 전체 — 선택한 질병 중 하나라도 연관된 유전자를 사용했습니다.',
      ...
      'choose.subtitle': '두 개 이상의 질병을 선택했습니다. 모든 질병이 공유하는 유전자(교집합), 어느 질병이든 연관된 유전자(합집합) 중 무엇을 사용할지, 아니면 둘 다 나란히 분석할지 선택하세요.',
      ...
      'result.kpiDiseasesCombined': '결합된 질병',
