...
(function (global) {
  ...
  var I18N = {
    en: {
      ...
      'choose.intersectionMeaning': 'Common disease drivers',
      'choose.unionMeaning': 'Full disease-gene landscape',
      'choose.bothMeaning': 'Compare both',
    ...
    ko: {
      ...
      'choose.intersectionMeaning': '질환 공통 유발요인',
      'choose.unionMeaning': '전체 질환 연관 유전자',
      'choose.bothMeaning': '공통 + 전체 비교',
